...
public class EditorActivity extends AppCompatActivity implements
    ...
    /** EditText field to enter the item's amount */
    private EditText mAmountEditText;

    /** EditText field to enter the item's price */
    private Spinner mPriceSpinner;

    private int mPrice = ItemContract.ItemEntry.PRICE_LOW;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameEditText = (EditText) findViewById(R.id.edit_overview);
        mBrandEditText = (EditText) findViewById(R.id.edit_item_brand);
        mAmountEditText = (EditText) findViewById(R.id.edit_item_amount);
        mPriceSpinner = (Spinner) findViewById(R.id.spinner_item_type);
    ...
    /**
     * Setup the dropdown spinner that allows the user to select the gender of the item.
     */
        ...
        mPriceSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    if (selection.equals(getString(R.string.item_type_phone))) {
                        mPrice = ItemContract.ItemEntry.PRICE_HIGH;
                    } else if (selection.equals(getString(R.string.item_type_laptop))) {
                        mPrice = ItemContract.ItemEntry.PRICE_MIDDLE;;
                    } else {
                        mPrice = ItemContract.ItemEntry.PRICE_LOW;;
                    }
                }
            }
    ...
    private void saveItem() {
        ...
        if (mCurrentItemUri == null &&
                ...
                TextUtils.isEmpty(amountString) && mPrice == ItemContract.ItemEntry.PRICE_LOW) {
        ...
        values.put(ItemContract.ItemEntry.COLUMN_ITEM_BRAND, brandString);
        ...
        values.put(ItemContract.ItemEntry.COLUMN_ITEM_AMOUNT, amount);
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        ...
        String[] projection = {
                ...
                ItemContract.ItemEntry.COLUMN_ITEM_AMOUNT };
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int amountColumnIndex = cursor.getColumnIndex(ItemContract.ItemEntry.COLUMN_ITEM_AMOUNT);
            ...
            switch (price) {
                case ItemContract.ItemEntry.PRICE_HIGH:
                    mPriceSpinner.setSelection(1);
                    break;
                case ItemContract.ItemEntry.PRICE_MIDDLE:
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        mPriceSpinner.setSelection(0); // Select "low" price
    }
